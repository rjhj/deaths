...
# Find 23 most common causes to be used with fct_other() later
df_11br |>
  slice_max(order_by = Total_deaths, n = 50*23) |>
  distinct(Cause) -> most_common_causes

# Combine less common causes together  
df_11br |>
...
colors_24 <- c(
  ...
  "orange", "#68D359FF", "#6B42C8FF", "#C9D73DFF",
  "#C555CBFF", "#CB7C77FF", "#502E71FF", "#C49A3FFF",
  "#33333CFF", "#AED688FF", "#6A7DC9FF", "#D7652DFF",
  "#7CD5C8FF", "#507D41FF", "#5D8D9CFF", "#C8B693FF",
  "#C5383CFF", "#674C2AFF", "white",  "#722E41FF")

# Function to create and save a plot
save_cause_year_plot <- function(col_y, title, filename) {
...
save_cause_year_plot(d_all, "Yearly deaths by cause (1971-2020)", "images//plot_cause_year_1.png")
