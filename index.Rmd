...
From the age-standardized plot above we can see that while death rates for most causes are getting lower, dementia (red color in the chart) has been getting worse. Part of the reason was given by [stat.fi](https://www.stat.fi/til/ksyyt/2020/ksyyt_2020_2021-12-10_kat_003_en.html):
