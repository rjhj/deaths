...
This work visualizes different statistics related to deaths and their causes in Finland.
...
These plots were created using R's ggplot2 library, which is a part of [Tidyverse](https://www.tidyverse.org/).

Click the *Code* buttons to see the source code.
...
```
![](images/plot_cause_year_1.png)
![](images/plot_cause_year_2.png)
![](images/plot_cause_year_3.png)

While death rates for most causes have been falling, deaths caused by dementia (red color on the charts) have been increasing. Part of the reason was given by [stat.fi](https://www.stat.fi/til/ksyyt/2020/ksyyt_2020_2021-12-10_kat_003_en.html):
...
However, this doesn't seems to explain all the growth. It will be interesting to see if the age-standardised deaths caused by dementia will continue to increase in the coming years.
...
Deaths in this section were calculated as sums of deaths for a five year period between 2016 and 2020 for each region. Expected deaths were calculated by comparing all the deaths in Finland for the same period and standardised for each region by age, sex and population. Then deaths were divided by expected deaths to get Standardised Mortality Ratio (SMR). SMR over 1 is represented with red, around 1 with white and under 1 with blue.
