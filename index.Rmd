...
While death rates for most causes have been falling, deaths caused by dementia (red color in the charts) have been getting worse. Part of the reason was given by [stat.fi](https://www.stat.fi/til/ksyyt/2020/ksyyt_2020_2021-12-10_kat_003_en.html):
...
However, this doesn't seems to explain all the growth. It will be interesting to see if the age-standardised deaths caused by dementia will continue increasing in the coming years.
