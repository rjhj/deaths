...
This work visualizes different statistics related to deaths in Finland. Death is a relevant topic to every human, but it's often hard to intuitively understand how and when people usually die. Hopefully these visualizations can help to create a more accurate understanding on the topic.
...
Click the *Code* buttons to see the code.
